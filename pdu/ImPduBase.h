...
public:
    ...
    uchar_t* GetBuffer() const;
    uint32_t GetLength() const;
    uchar_t* GetBodyData() const;
    ...
    uint16_t GetServiceId() const{ return m_pdu_header.service_id; }
    uint16_t GetCommandId() const{ return m_pdu_header.command_id; }
